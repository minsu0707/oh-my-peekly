...
export function registerSettingsTools(server) {
    server.registerTool("get_setting", {
        ...
        description: "Look up a previously saved non-secret Peekly setting (e.g. whether to review each issue " +
    ...
    server.registerTool("save_setting", {
        title: "Save setting",
        description: "Persist a non-secret Peekly setting (e.g. whether to review each issue individually) so future " +
