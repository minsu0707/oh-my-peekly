...
export function registerPlatformTools(server: McpServer): void {
  server.registerTool(
    "save_credentials",
    {
      ...
      description:
        "Cache a login ID/password for a service URL in the OS credential store (Keychain on macOS, " +
  ...
  server.registerTool(
    "get_credentials",
    {
      ...
      description:
        "Look up a previously cached login ID/password for a service URL. Returns found: false (not an error) " +
  ...
  server.registerTool(
    "find_local_file",
    {
      ...
      description:
        "Search OS-appropriate fixed locations (Spotlight on macOS, a fixed set of recursively-searched " +
  ...
  server.registerTool(
    "open_in_viewer",
    {
      ...
      description:
        "Open a file (e.g. a screenshot) in the OS's default viewer/associated app (`open` on macOS, " +
