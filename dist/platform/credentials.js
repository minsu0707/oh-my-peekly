 ...
 */
function normalizeAccount(serviceUrl) {
 ...
 * section 5).
 */
export async function saveCredentials(serviceUrl, loginId, password) {
    const account = normalizeAccount(serviceUrl);
    const secret = { loginId, password };
 ...
 */
export async function getCredentials(serviceUrl) {
    const account = normalizeAccount(serviceUrl);
 ...
 */
export async function deleteCredentials(serviceUrl) {
    const account = normalizeAccount(serviceUrl);
